...
// //==========
// // server/routes/agreement.js - SIMPLE VERSION
// import express from 'express';
// import nodemailer from 'nodemailer';

// const router = express.Router();

// // Use your Gmail (already working)
// const transporter = nodemailer.createTransport({
//   service: 'gmail',
//   auth: {
//     user: 'besttripmakers@gmail.com',
//     pass: 'snomrnnglqgtfqsg' // your app password
//   }
// });
...
//   console.log('📝 Agreement clicked:', { email, booking, ipAddress });
...
//       subject: `✅ Customer Agreed - ${booking}`,
//       html: `
//         <h3>Customer Clicked "I Agree"</h3>
//         <p><strong>Customer:</strong> ${customerName}</p>
//         <p><strong>Email:</strong> ${email}</p>
...
//       `
//     });
//     console.log('✅ Email sent to besttripmakers@gmail.com');
//   } catch (error) {
...
//     <head>
//       <style>
//         body { font-family: Arial; padding: 30px; text-align: center; background: #f0f9ff; }
//         .box { background: white; padding: 30px; border-radius: 15px; max-width: 500px; margin: auto; }
//         .ip { background: #f3f4f6; padding: 10px; border-radius: 5px; font-family: monospace; }
//       </style>
//     </head>
//     <body>
//       <div class="box">
...
//         <p><strong>Time:</strong> ${timestamp}</p>
//         <hr>
//         <p>Check <strong>besttripmakers@gmail.com</strong> for the notification.</p>
