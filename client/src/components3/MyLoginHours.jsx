...
//   if (!data) {
//     return <p className="p-4 text-gray-500">No login record for today</p>;
//   }

//   return (
//     <div className="bg-white rounded shadow p-4">
//       <h2 className="text-lg font-semibold mb-4">
//         Today Login Hours ({dayjs().format("DD MMM YYYY")})
//       </h2>
...
//             {dayjs(data.loginTime).format("hh:mm A")}
//           </p>
//         </div>
...
//           <p className="font-medium">
//             {data.logoutTime
//               ? dayjs(data.logoutTime).format("hh:mm A")
//               : "—"}
//           </p>
//         </div>

//         <div>
//           <p className="text-gray-500">Worked Time</p>
//           <p className="font-medium">
//             {formatMinutes(data.workedHours * 60)}
//           </p>
//         </div>
...
//           <p className="font-medium">
//             {formatMinutes(data.breakMinutes)}
//           </p>
//         </div>
...
const MyLoginHours = () => {
  ...
  return (
    <div>
      <h2>Today Login Hours</h2>

      {!data.loggedIn ? (
        <p>Status: Absent</p>
      ) : (
        <>
          <p>Shift Start: {new Date(data.loginTime).toLocaleTimeString()}</p>
          <p>
            Logout:{" "}
            {data.logoutTime
              ? new Date(data.logoutTime).toLocaleTimeString()
              : "--"}
          </p>
          <p>Worked: {formatHM(data.workedMinutes)}</p>
          <p>Break: {formatHM(data.breakMinutes)}</p>
          <p>Status: Present</p>
        </>
      )}
    </div>
