...
//                   <th className="px-6 py-4 text-center">Amount (SP)</th>
...
//                     <td className="px-6 py-4 text-center">
//   <div className={`flex items-center justify-center gap-1 font-bold ${b.status === 'REFUND' ? 'text-red-700' : 'text-gray-900'}`}>
//     <DollarSign size={16} />
//     {(
//       b.status === "REFUND"
//         ? -(Number(b.sellingPrice || 0) - Number(b.costPrice || 0) - Number(b.otherExpense || 0) - Number(b.cbFees || 0))
//         : Number(b.sellingPrice || 0) - Number(b.costPrice || 0) - Number(b.otherExpense || 0) - Number(b.cbFees || 0)
//     ).toLocaleString("en-IN")}
//   </div>
// </td>
