...
//                 navigate(`/invoice/${invoiceNumber}/success`);
//               } catch (err) {
...
//             {invoice.paymentStatus === "PAID" ? "✅ Paid" : "📅 Due: " + new Date(invoice.dueDate).toLocaleDateString()}
//           </p>
//         </div>
...
//               {invoice.bookingRef && <p className="text-gray-600">Booking: {invoice.bookingRef}</p>}
//             </div>
//           </div>
...
//                   </div>
//                   <div>
//                     <h4 className="font-bold text-green-800">Payment Complete</h4>
...
//                   </div>
//                   <div>
//                     <h4 className="font-bold text-yellow-800">Payment Pending</h4>
//                     <p className="text-yellow-600">
//                       Please complete payment before {new Date(invoice.dueDate).toLocaleDateString()}
//                     </p>
//                   </div>
//                 </>
//               )}
...
//                 disabled={paying}
//                 className="bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white font-semibold px-6 py-3 rounded-lg disabled:opacity-50 cursor-pointer"
//               >
//                 {paying ? "Processing..." : `Pay Now - $${invoice.amount}`}
//               </button>
//             )}
...
//               className="bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium px-6 py-3 rounded-lg border cursor-pointer"
//             >
//               Download Invoice
//             </button>
...
//             {/* View in CRM */}
//             <button
//               onClick={() => navigate(`/crm/invoices/${invoice.invoiceNumber}`)}
//               className="bg-blue-100 hover:bg-blue-200 text-blue-700 font-medium px-6 py-3 rounded-lg cursor-pointer"
//             >
//               View in CRM
//             </button>
//           </div>
